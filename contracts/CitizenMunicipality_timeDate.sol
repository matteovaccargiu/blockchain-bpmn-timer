 ...
 */
contract CitizenMunicipality_timeDate is ReentrancyGuard, Ownable, Pausable {
    ...
    function sendRequestToMunicipality() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SendRequestMunicipality"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Citizen"], "Only Citizen can do this task");
    ...
    function documentsReceived() public nonReentrant whenNotPaused {
        require(elementStates["Activity_DocumentsReceived"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Citizen"], "Only Citizen can do this task");
    ...
    function sendFeedback() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SendFeedback"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Citizen"], "Only Citizen can do this task");
    ...
    function completeRequestAndResendIt() public nonReentrant whenNotPaused {
        require(elementStates["Activity_CompleteRequestAndResend"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Citizen"], "Only Citizen can do this task");
    ...
    function elaborateRequest() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ElaborateRequest"] == State.ENABLED, "NE");
        ...
        blockLimits["Event_30DayDeadline"] = block.number + 436073;
        elementStates["Event_30DayDeadline"] = State.ENABLED;
        emit TimerScheduled("Event_30DayDeadline", block.number + 436073);
    }

    function returnRequestToCitizen() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ReturnRequestToCitizen"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Municipality"], "Only Municipality can do this task");
    ...
    function sendDocuments() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SendDocuments"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Municipality"], "Only Municipality can do this task");
    ...
    function assignNewOperator() public nonReentrant whenNotPaused {
        require(elementStates["Activity_AssignNewOperator"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Municipality"], "Only Municipality can do this task");
        ...
        blockLimits["Event_15DayDeadline"] = block.number + 1202873;
        elementStates["Event_15DayDeadline"] = State.ENABLED;
        emit TimerScheduled("Event_15DayDeadline", block.number + 1202873);
    }
    ...
    function triggerF30DaysDeadlineForDocumentDelivery() public nonReentrant whenNotPaused {
        require(elementStates["Event_30DayDeadline"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_30DayDeadline"], "Timer not expired yet");
        elementStates["Event_30DayDeadline"] = State.DONE;
        logAudit("Event_30DayDeadline");
        emit TaskCompleted("Event_30DayDeadline");
    ...
    function triggerF15DaysExtendedDeadline() public nonReentrant whenNotPaused {
        require(elementStates["Event_15DayDeadline"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_15DayDeadline"], "Timer not expired yet");
        elementStates["Event_15DayDeadline"] = State.DONE;
        logAudit("Event_15DayDeadline");
        emit TaskCompleted("Event_15DayDeadline");
