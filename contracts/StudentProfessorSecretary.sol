...
contract StudentProfessorSecretary is ReentrancyGuard, Ownable, Pausable {
    ...
    function fixExamDate() public nonReentrant whenNotPaused {
        require(elementStates["Task_FixExamDate"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Professor"], "Only Professor can do this task");
    ...
    function receiveStudentList() public nonReentrant whenNotPaused {
        require(elementStates["Task_ReceiveStudentList"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Professor"], "Only Professor can do this task");
    ...
    function evaluateExams() public nonReentrant whenNotPaused {
        require(elementStates["Task_EvaluateExams"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Professor"], "Only Professor can do this task");
        ...
        blockLimits["Event_15DaysTimer"] = block.number + 108000;
        elementStates["Event_15DaysTimer"] = State.ENABLED;
        emit TimerScheduled("Event_15DaysTimer", block.number + 108000);
    }

    function sendScores() public nonReentrant whenNotPaused {
        require(elementStates["Task_SendScores"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Professor"], "Only Professor can do this task");
    ...
    function registerForExam() public nonReentrant whenNotPaused {
        require(elementStates["Task_RegisterForExam"] == State.ENABLED, "NE");
    ...
    function receiveScore() public nonReentrant whenNotPaused {
        require(elementStates["Task_ReceiveScore"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Student"], "Only Student can do this task");
        ...
        blockLimits["Event_7DaysTimer"] = block.number + 50400;
        elementStates["Event_7DaysTimer"] = State.ENABLED;
        emit TimerScheduled("Event_7DaysTimer", block.number + 50400);
    }

    function sendRejection() public nonReentrant whenNotPaused {
        require(elementStates["Task_SendRejection"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Student"], "Only Student can do this task");
    ...
    function sendAcceptance() public nonReentrant whenNotPaused {
        require(elementStates["Task_SendAcceptance"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Student"], "Only Student can do this task");
    ...
    function takeExam() public nonReentrant whenNotPaused {
        require(elementStates["Task_TakeExam"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Student"], "Only Student can do this task");
    ...
    function openRegistration() public nonReentrant whenNotPaused {
        require(elementStates["Task_OpenRegistration"] == State.ENABLED, "NE");
        ...
        blockLimits["Event_7DaysRegistrationTimer"] = block.number + 50400;
        elementStates["Event_7DaysRegistrationTimer"] = State.ENABLED;
        emit TimerScheduled("Event_7DaysRegistrationTimer", block.number + 50400);
    }

    function closeRegistration() public nonReentrant whenNotPaused {
        require(elementStates["Task_CloseRegistration"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function listStudentRegistered() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ListStudentRegistered"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function sendStudentList() public nonReentrant whenNotPaused {
        require(elementStates["Task_SendStudentList"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function receiveScores() public nonReentrant whenNotPaused {
        require(elementStates["Task_ReceiveScores"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function registerFinalScore() public nonReentrant whenNotPaused {
        require(elementStates["Task_RegisterFinalScore"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function informStudents() public nonReentrant whenNotPaused {
        require(elementStates["Task_InformStudents"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function addStudentList() public nonReentrant whenNotPaused {
        require(elementStates["Activity_AddStudentList"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function receiveDecision() public nonReentrant whenNotPaused {
        require(elementStates["Task_ReceiveDecision"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Secretary"], "Only Secretary can do this task");
    ...
    function triggerF15DaysDeadline() public nonReentrant whenNotPaused {
        require(elementStates["Event_15DaysTimer"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_15DaysTimer"], "Timer not expired yet");
        elementStates["Event_15DaysTimer"] = State.DONE;
        logAudit("Event_15DaysTimer");
        emit TaskCompleted("Event_15DaysTimer");
    ...
    function triggerF7DaysDeadline() public nonReentrant whenNotPaused {
        require(elementStates["Event_7DaysTimer"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_7DaysTimer"], "Timer not expired yet");
        elementStates["Event_7DaysTimer"] = State.DONE;
        logAudit("Event_7DaysTimer");
        emit TaskCompleted("Event_7DaysTimer");
    ...
    function triggerF7DaysPeriod() public nonReentrant whenNotPaused {
        require(elementStates["Event_7DaysRegistrationTimer"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_7DaysRegistrationTimer"], "Timer not expired yet");
        elementStates["Event_7DaysRegistrationTimer"] = State.DONE;
        logAudit("Event_7DaysRegistrationTimer");
        emit TaskCompleted("Event_7DaysRegistrationTimer");
