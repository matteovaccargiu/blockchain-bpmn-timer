...
contract PolicyholderInsuranceCompany is ReentrancyGuard, Ownable, Pausable {
    ...
    function provideAdditionalInfo() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ProvideAdditionalInfo"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Policyholder"], "Only Policyholder can do this task");
    ...
    function receiveProposal() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ReceiveProposal"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Policyholder"], "Only Policyholder can do this task");
        ...
        blockLimits["Event_5DayDeadline"] = block.number + 36000;
        elementStates["Event_5DayDeadline"] = State.ENABLED;
        emit TimerScheduled("Event_5DayDeadline", block.number + 36000);
    }

    function submitInsurancePolicyRequest() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SubmitRequestPolicy"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Policyholder"], "Only Policyholder can do this task");
    ...
    function sendPolicySigned() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SendPolicySigned"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Policyholder"], "Only Policyholder can do this task");
    ...
    function prepareNewProposal() public nonReentrant whenNotPaused {
        require(elementStates["Activity_PrepareNewProposal"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["Policyholder"], "Only Policyholder can do this task");
    ...
    function requestMoreInfo() public nonReentrant whenNotPaused {
        require(elementStates["Activity_RequestMoreInfo"] == State.ENABLED, "NE");
    ...
    function receivePolicySigned() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ReceivePolicySigned"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["InsuranceCompany"], "Only InsuranceCompany can do this task");
        ...
        elementStates["Event_EndPolicyProcess"] = State.ENABLED;
    }

    function preparePolicyProposal() public nonReentrant whenNotPaused {
        require(elementStates["Activity_PreparePolicyProposal"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["InsuranceCompany"], "Only InsuranceCompany can do this task");
        ...
        blockLimits["Event_7DayDeadline"] = block.number + 50400;
        elementStates["Event_7DayDeadline"] = State.ENABLED;
        emit TimerScheduled("Event_7DayDeadline", block.number + 50400);
    }

    function sendPolicyProposal() public nonReentrant whenNotPaused {
        require(elementStates["Activity_SendPolicyProposal"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["InsuranceCompany"], "Only InsuranceCompany can do this task");
    ...
    function receiveRequest() public nonReentrant whenNotPaused {
        require(elementStates["Activity_ReceiveRequest"] == State.ENABLED, "NE");
        require(msg.sender == participantAddresses["InsuranceCompany"], "Only InsuranceCompany can do this task");
    ...
    function triggerF5DaysSignDeadline() public nonReentrant whenNotPaused {
        require(elementStates["Event_5DayDeadline"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_5DayDeadline"], "Timer not expired yet");
        elementStates["Event_5DayDeadline"] = State.DONE;
        logAudit("Event_5DayDeadline");
        emit TaskCompleted("Event_5DayDeadline");
    ...
    function triggerF7DaysProposalDeadline() public nonReentrant whenNotPaused {
        require(elementStates["Event_7DayDeadline"] == State.ENABLED, "Timer event not enabled");
        require(block.number >= blockLimits["Event_7DayDeadline"], "Timer not expired yet");
        elementStates["Event_7DayDeadline"] = State.DONE;
        logAudit("Event_7DayDeadline");
        emit TaskCompleted("Event_7DayDeadline");
